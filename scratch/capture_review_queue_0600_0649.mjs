...
const queuePath = 'scratch/menu-collection-queue/2026-07-15T08-48-08-914Z/review_queue.json';
const outDir = path.join('scratch', 'review-0600-0649', new Date().toISOString().replace(/[:.]/g, '-'));
fs.mkdirSync(outDir, { recursive: true });

const queue = JSON.parse(fs.readFileSync(queuePath, 'utf8'));
const targets = [
  '7b5c2c7c-d53b-48d9-823a-963adb9a5492',
  '6aeda141-0dd0-4cc8-b54e-2e7ab83fa96f',
  '3eeb4b15-4fd2-4bbe-97c0-dcc0fcff19cd',
  '734bcef3-60be-4f39-a750-c297d9b47fd9',
  'a850e973-8c1d-4d56-bb61-9b245addfb92',
];
