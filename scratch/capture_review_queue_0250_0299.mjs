...
const queuePath = 'scratch/menu-collection-queue/2026-07-15T08-01-46-507Z/review_queue.json';
const outDir = path.join('scratch', 'review-0250-0299', new Date().toISOString().replace(/[:.]/g, '-'));
fs.mkdirSync(outDir, { recursive: true });

const queue = JSON.parse(fs.readFileSync(queuePath, 'utf8'));
const targets = [
  '697e9169-1817-4591-ab82-5046f7ed61f7',
  '5856d772-b447-4fbc-b8ac-9e0dac7fb144',
  '8803e161-9701-4df7-a15d-ae3cc443088d',
  '20e198de-9e83-4e5f-8c32-b02e05509803',
  'a6af09eb-18a1-4024-9cbc-0b1ddb1cfc65',
];
