...
const queuePath = 'scratch/menu-collection-queue/2026-07-15T08-37-58-789Z/review_queue.json';
const outDir = path.join('scratch', 'review-0500-0549', new Date().toISOString().replace(/[:.]/g, '-'));
fs.mkdirSync(outDir, { recursive: true });

const queue = JSON.parse(fs.readFileSync(queuePath, 'utf8'));
const targets = [
  '6157e683-2efe-4277-88d0-4af3a0397b05',
  'b48f986c-fea5-4e3f-a311-21912f4b9822',
  '6814b93b-1d80-4e06-bc41-5bd3f0aa051d',
  '8cbf8b2f-b0f8-4072-9942-e4a0f0debacb',
  'f7637843-85be-487a-9bac-db236a66d9cb',
];
