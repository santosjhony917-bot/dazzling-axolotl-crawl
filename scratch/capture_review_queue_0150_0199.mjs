...
const queuePath = 'scratch/menu-collection-queue/2026-07-15T07-48-32-517Z/review_queue.json';
const outDir = path.join('scratch', 'review-0150-0199', new Date().toISOString().replace(/[:.]/g, '-'));
fs.mkdirSync(outDir, { recursive: true });

const queue = JSON.parse(fs.readFileSync(queuePath, 'utf8'));
const targets = [
  '4e987d9c-7696-4bbe-ae66-8d5cd63c97de',
  'b940cbe2-7dd2-4837-a3a7-6648fdf0c8a4',
  '444cca3b-7d96-44e2-acef-d68e42bb6735',
  'ce21467e-be2e-4f0f-9804-5125f14ca795',
  'e5554e3b-9535-4588-afd4-10f5f0d7b486',
];
