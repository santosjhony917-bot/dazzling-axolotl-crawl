...
const queuePath = 'scratch/menu-collection-queue/2026-07-15T08-14-22-013Z/review_queue.json';
const outDir = path.join('scratch', 'review-0350-0399', new Date().toISOString().replace(/[:.]/g, '-'));
fs.mkdirSync(outDir, { recursive: true });

const queue = JSON.parse(fs.readFileSync(queuePath, 'utf8'));
const targets = [
  '846e1d9e-d2a0-469d-bcf5-1cd5fe1ceafc',
  '2741f5a1-f47c-4dd8-9c5d-290fb6aafd15',
  '38b7681d-735a-4c42-a3d8-d07fd4b2aef5',
  '88da4b0d-7a45-43ab-8c86-1d7b74a32445',
  'fd514a04-3765-4581-9952-e6cca3e94d79',
];
