...
function parseTimeString(timeStr) {
  // Parses "12:00–15:00" into { start: "12:00", end: "15:00" }
  // Handles en-dash and normal hyphen
...
function parseSchedule(ptHours) {
  ...
  // Process rules
  // Example 1: "segunda_a_sabado": "11:30–22:00", "domingo": "11:30–22:00"
  // Example 2: "segunda_a_quinta": "12:00–15:00, 18:30–23:00", "sexta_a_sabado": "12:00–23:30", "domingo": "12:00–22:00"
  // Example 3: "segunda_a_domingo": "11:30–15:30, 18:30–23:00"
  // Example 4: "terca_a_domingo": "12:00–15:00, 18:30–23:00", "segunda": "Fechado"
  
  for (const [key, value] of Object.entries(ptHours)) {
    if (value === "Fechado") continue;

    // Parse time slots (split by comma, e.g. "12:00–15:00, 18:30–23:00")
