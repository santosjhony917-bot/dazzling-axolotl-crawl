-- 22. Adiciona a coluna search_display_name e atualiza a função search_menu_items
ALTER TABLE public.menu_items ADD COLUMN IF NOT EXISTS search_display_name text;
...
SELECT
    mi.id AS item_id,
    -- Retorna o nome de exibição otimizado se disponível, senão o original
