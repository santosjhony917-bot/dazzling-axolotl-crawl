...
const RestaurantCard: React.FC<RestaurantCardProps> = ({ restaurant, onClick }) => {
  ...
  return (
    ...
    >
      <Card 
        className="w-full overflow-hidden rounded-xl shadow-soft-lg cursor-pointer transition-transform duration-200 border-none bg-white"
      >
        <div className="relative h-40 bg-gray-100">
          ...
          {restaurant.plan !== 'free' && (
            <div className="absolute top-3 left-3 bg-highlight text-white text-xs font-bold px-3 py-1 rounded-full shadow-soft-md flex items-center">
