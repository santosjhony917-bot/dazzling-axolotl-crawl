...
import { ArrowLeft, Settings, Utensils, Image, Link, Clock, Loader2, MapPin, MessageSquare, Globe, FileText, Phone, Mail, Crown, AlertTriangle } from 'lucide-react'; // CORREÇÃO 6: Importando AlertTriangle
...
import { Json } from '@/lib/database.types'; // Importando o tipo Json
...
const ProfileManagementLayout: React.FC = () => {
  ...
  // CORREÇÃO 4: Conversão segura de Json para WeekSchedule
  const currentSchedule: WeekSchedule = (restaurant?.opening_hours as WeekSchedule | null) || defaultSchedule; 
  ...
  const handleSaveHours = async (newSchedule: WeekSchedule) => {
    // CORREÇÃO 5: O tipo WeekSchedule é compatível com Json (JSONB)
