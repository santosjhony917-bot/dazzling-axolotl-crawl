...
const AdminLayout: React.FC = () => {
  ...
  if (!user || !isAdmin) {
    ...
    // O ProtectedRoute já deve lidar com isso, mas um fallback aqui é bom.
    // Se o isProfileLoading for false e não for admin, redireciona.
    if (!isProfileLoading) {
      navigate('/admin/login');
    }
    return null; // Retorna null para evitar renderizar o layout antes do redirecionamento
  }
