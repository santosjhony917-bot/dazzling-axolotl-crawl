...
export const MAPS_COLLECTION_EXTENSION_TERMS: MapsCollectionExtensionTerm[] = [
  ...
  { label: 'Lanches/Fast Food', term: 'pastelaria', coverage: 'all_neighborhoods' },
  { label: 'Lanches/Fast Food', term: 'salgados', coverage: 'all_neighborhoods' },
  { label: 'Lanches/Fast Food', term: 'esfiharia', coverage: 'all_neighborhoods' },
  { label: 'Lanches/Fast Food', term: 'creperia', coverage: 'all_neighborhoods' },
  { label: 'Lanches/Fast Food', term: 'tapiocaria', coverage: 'all_neighborhoods' },
  { label: 'Lanches/Fast Food', term: 'food truck', coverage: 'all_neighborhoods' },
  { label: 'Lanches/Fast Food', term: 'sanduicheria', coverage: 'all_neighborhoods' },
  { label: 'Lanches/Fast Food', term: 'cachorro quente', coverage: 'all_neighborhoods' },
  { label: 'Lanches/Fast Food', term: 'petiscaria', coverage: 'all_neighborhoods' },
  { label: 'Lanches/Fast Food', term: 'espetinho', coverage: 'all_neighborhoods' },
  ...
  { label: 'Café/Sobremesas/Açaí', term: 'sorveteria', coverage: 'all_neighborhoods' },
  { label: 'Café/Sobremesas/Açaí', term: 'doceria', coverage: 'all_neighborhoods' },
  { label: 'Café/Sobremesas/Açaí', term: 'confeitaria', coverage: 'all_neighborhoods' },
  { label: 'Café/Sobremesas/Açaí', term: 'bolos', coverage: 'all_neighborhoods' },
  { label: 'Café/Sobremesas/Açaí', term: 'milkshake', coverage: 'all_neighborhoods' },
  { label: 'Japonesa/Oriental', term: 'comida japonesa', coverage: 'all_neighborhoods' },
  { label: 'Japonesa/Oriental', term: 'sushi', coverage: 'all_neighborhoods' },
  { label: 'Japonesa/Oriental', term: 'temakeria', coverage: 'all_neighborhoods' },
  { label: 'Japonesa/Oriental', term: 'yakisoba', coverage: 'all_neighborhoods' },
  { label: 'Japonesa/Oriental', term: 'comida chinesa', coverage: 'all_neighborhoods' },
  { label: 'Japonesa/Oriental', term: 'comida oriental', coverage: 'all_neighborhoods' },
  ...
  { label: 'Refeições/Restaurantes', term: 'self service', coverage: 'all_neighborhoods' },
  { label: 'Refeições/Restaurantes', term: 'buffet', coverage: 'all_neighborhoods' },
  { label: 'Refeições/Restaurantes', term: 'prato feito', coverage: 'all_neighborhoods' },
  { label: 'Refeições/Restaurantes', term: 'comida caseira', coverage: 'all_neighborhoods' },
  { label: 'Refeições/Restaurantes', term: 'comida brasileira', coverage: 'all_neighborhoods' },
  { label: 'Refeições/Restaurantes', term: 'bar e restaurante', coverage: 'all_neighborhoods' },
  { label: 'Refeições/Restaurantes', term: 'bar', coverage: 'all_neighborhoods' },
  { label: 'Refeições/Restaurantes', term: 'restaurante delivery', coverage: 'all_neighborhoods' },
  { label: 'Refeições/Restaurantes', term: 'comida nordestina', coverage: 'all_neighborhoods' },
  { label: 'Refeições/Restaurantes', term: 'frango assado', coverage: 'all_neighborhoods' },
  { label: 'Refeições/Restaurantes', term: 'frutos do mar', coverage: 'all_neighborhoods' },
