...
import { MapPin, Search, DollarSign, Compass, Utensils, Loader2, Bell } from 'lucide-react';
...
const RestaurantDashboard: React.FC = () => {
  ...
  const { restaurant, isLoading: isRestaurantDataLoading } = useRestaurantData();
  ...
  return (
    <div className="bg-[#f5f7f8] min-h-screen pb-20">
      ...
      {/* Header com Nome do Restaurante e Notificações */}
      <header className="bg-white p-4 shadow-soft-md sticky top-0 z-10 flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-base font-extrabold text-[#022D68] tracking-tight truncate max-w-[150px]">
        ...
        <div>
          <div className="flex justify-between items-center mb-4">
            ...
            <Button 
              ...
              onClick={() => navigate(createPageUrl('search-unified', { category: 'popular' }))}
            >
              Ver todos
            </Button>
          </div>
                    ...
                    {popularMenuItems.map((item) => (
                      <HighlightCard 
                        ...
                        item={{
                          ...
                          price: item.price,
                          imageUrl: item.imageUrl || 'https://via.placeholder.com/300x200?text=Prato+Popular',
                        }} 
        ...
        <div>
          <div className="flex justify-between items-center mb-4">
            ...
            <Button 
              variant="link" 
              className="text-highlight p-0 h-auto text-sm font-semibold"
              onClick={() => navigate(createPageUrl('search-unified', { type: 'nearby' }))}
            >
              Ver todos
            </Button>
          </div>
