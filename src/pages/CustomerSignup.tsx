      ...
      <header className="flex flex-col items-center justify-center pt-16 pb-6 w-full max-w-sm">
        <div className="w-36 h-auto drop-shadow-md">
          <svg viewBox="125 -5 100 110" className="w-36 h-auto">
            <g transform="matrix(-1.022,0,0,1.022,227.94,-1.794)" fill="#032d63">
        ...
        <Card className="w-full shadow-xl border-none rounded-xl">
          ...
          <CardContent>
            <div className="space-y-4">
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute inset-y-0 right-0 flex items-center pr-4 text-gray-500 hover:text-[#032d63] transition-colors"
                  type="button"
                >
            ...
            <p className="pt-6 text-center text-base text-gray-600">
              ...
              <Link
                to="/customer-login"
                className="font-bold text-[#032d63] hover:underline ml-1"
              >
                Entrar
              </Link>
            </p>
