    ...
    <div className="relative">
      ...
      <div className="w-full h-48 bg-gray-200 relative mb-0 p-0">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex items-end p-4">
          <div className="flex items-center space-x-4 w-full"> {/* Adicionado w-full aqui */}
            ...
            <div className="flex-1 min-w-0"> {/* Adicionado flex-1 min-w-0 aqui */}
              <h1 className={cn(
                "font-bold text-white drop-shadow-md",
                currentPlan === 'free' ? "text-2xl leading-tight" : "text-3xl"
              )}>{restaurant.name}</h1>
