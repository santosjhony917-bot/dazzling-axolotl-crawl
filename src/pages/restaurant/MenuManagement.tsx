...
import { Utensils, Plus, Edit, Trash2, Loader2, ChevronDown, ChevronUp } from 'lucide-react';
...
const MenuManagement: React.FC = () => {
  ...
  const moveCategory = async (categoryId: string, direction: 'up' | 'down') => {
    ...
    if (error) {
      ...
      fetchMenuData(); // Re-fetch to ensure consistent state
    }
  };
  ...
  if (loading) {
    return (
      <RestaurantAreaPageLayout title="Carregando Cardápio" icon={Loader2}>
  ...
  return (
    <RestaurantAreaPageLayout title="Gerenciar Cardápio" icon={Utensils}>
