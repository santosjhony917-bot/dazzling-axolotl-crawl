...
import { Loader2, Utensils, Settings, Menu, Image, MapPin, Star, Eye } from 'lucide-react'; // Adicionado Eye
...
const RestaurantHomePage: React.FC = () => {
  ...
  return (
    <RestaurantAreaPageLayout 
      title={`Bem-vindo(a), ${restaurant.name}`} 
      icon={Utensils} 
      ...
      <div className="p-4 space-y-8">
        ...
        <Card className="bg-primary/5 dark:bg-gray-800">
          <CardContent className="pt-6">
            <h2 className="text-xl font-semibold mb-2 text-primary dark:text-primary-light">Seu Perfil</h2>
