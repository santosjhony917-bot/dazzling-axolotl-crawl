...
export default function RestaurantProfilePage() {
  ...
  return (
    <div className="min-h-screen bg-[#f5f7f8] pb-20 max-w-md mx-auto">
      <RestaurantAreaHeader title="Dados do Estabelecimento" icon={Info} backPath="restaurant-area/profile-menu" />
      ...
      <main className="p-4 space-y-6">
        ...
        <Card className="shadow-xl rounded-xl border-none">
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button type="submit" disabled={isSaving || uploadingLogo || uploadingCover} className="bg-[#E47948] hover:bg-[#E47948]/90">
                {isSaving ? (
        ...
        <Card className="shadow-xl rounded-xl border-none">
          <CardHeader>
            <CardTitle className="text-lg font-bold text-[#022D68]">Endereço e Localização</CardTitle>
          </CardHeader>
          <CardContent>
