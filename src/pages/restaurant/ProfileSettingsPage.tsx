...
import { Loader2, Trash2, PlusCircle, MapPin, Clock } from 'lucide-react';
...
import { Restaurant, WeekSchedule, PaymentMethod, SocialNetwork } from '@/types';
...
export default function ProfileSettingsPage() {
  ...
  useEffect(() => {
    if (restaurant) {
      ...
      setPaymentMethods(restaurant.payment_methods || []);
