...
const menuItems = [
  ...
  },
  {
    ...
    description: 'Atualize informações básicas, endereço e horário de funcionamento.',
    icon: Settings,
    path: '/restaurant-area/profile-settings',
  },
  {
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4 sm:p-6">
      <div className="max-w-4xl mx-auto">
        ...
        {/* Since the menu already contains a link to profile settings, removing the redundant button below */}
      </div>
    </div>
  );
};
