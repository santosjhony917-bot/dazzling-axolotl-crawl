    ...
    <div className="h-screen w-full relative flex items-center justify-center bg-[#E47948]">
      ...
      >
        {[0, 1, 2].map((i) => (
          <motion.div
            key={i}
            className="w-3 h-3 bg-[#000b7a]/70 rounded-full"
            animate={{
              scale: [1, 1.3, 1],
              opacity: [0.7, 1, 0.7],
            }}
