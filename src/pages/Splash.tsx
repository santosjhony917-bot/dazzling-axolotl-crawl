    ...
    if (!isLoading) {
      ...
      const timer = setTimeout(() => {
        if (isComplete) {
          ...
          // Se o onboarding não estiver completo, vai para a tela de Welcome (que leva ao Onboarding)
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-white text-primary">
      <div className="flex flex-col items-center mb-4">
        {/* Logo/Icone (Restaurado do Welcome/Auth para consistência) */}
        <div className="mb-4">
        ...
        <h1 className="text-4xl font-bold text-primary">FilterFood</h1>
      </div>
      <p className="text-lg text-gray-600 mb-8">Seu guia gastronômico.</p>
