    ...
    variables: {
      default: {
        colors: {
          ...
          socialButtonText: 'hsl(var(--primary))',
          socialButtonBorder: 'hsl(var(--border))',
          socialButtonBorderHover: 'hsl(var(--border))',
          socialButtonBackgroundHover: 'hsl(var(--secondary))',
        },
        radii: {
              ...
              {!isCodeVerified ? (
                ...
                <div className="mt-6">
                  ...
                  <Auth
                    ...
                    appearance={customAuthAppearance} // Using the custom appearance object
