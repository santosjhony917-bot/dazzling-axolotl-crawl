...
import PlanPreviewToggle from '@/components/upgrade/PlanPreviewToggle'; // Import as default
...
const UpgradePage: React.FC = () => {
  ...
  const handleUpgrade = async (plan: 'free' | 'basic' | 'premium') => { // Added 'free' to type
    if (!restaurant) {
  ...
  if (isLoading) {
    return (
      <RestaurantAreaPageLayout title="Gerenciar Plano">
      ...
      <div className="space-y-8 pb-20">
        <div className="text-center">
          <h1 className="text-4xl font-extrabold text-gray-900 dark:text-white mb-4">
            Escolha o Plano Perfeito para o seu Restaurante
          </h1>
          <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
            Aumente sua visibilidade, gerencie seu cardápio e atraia mais clientes com nossos planos exclusivos.
          </p>
        </div>

        <PlanPreviewToggle
          showPremiumPreview={showPremiumPreview}
          onToggle={() => setShowPremiumPreview(!showPremiumPreview)}
        />
        ...
        <section className="text-center text-gray-600 dark:text-gray-400">
          <p>
            Para mais informações sobre os planos ou para cancelar, entre em contato com nosso suporte.
          </p>
        </section>
      </div>
    </RestaurantAreaPageLayout>
