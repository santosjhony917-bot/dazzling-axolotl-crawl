  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      await base44.integrations.Core.SendEmail({
        to: email,
        subject: "Recuperação de Senha - GrubGo",
  ...
  return (
    <div className="min-h-screen bg-[#f1f5f9] w-full flex flex-col">
      ...
      <main className="flex-grow flex flex-col justify-center w-full px-4 py-6">
        ...
        >
          {/* Card Principal */}
          <div className="bg-white rounded-2xl shadow-none border border-slate-100/80 p-8">
          {/* Logo */}
          <div className="flex justify-center mb-8">
            <div className="w-24 h-auto">
              <svg viewBox="125 -5 100 110" className="w-full h-auto">
                <g transform="matrix(-1.022,0,0,1.022,227.94,-1.794)" fill="var(--primary)">
          ...
          {!success ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  <Input
                    ...
                    required
                    className="h-12 rounded-2xl border-gray-200 focus:border-highlight focus:ring-highlight text-base shadow-none"
                  />
                </div>
                ...
                <Button
                  ...
                  disabled={loading}
                  variant="highlight"
                  className="w-full h-12 rounded-2xl text-lg font-bold shadow-none transition-all duration-300"
                >
            ...
            >
              ...
              <Button
                ...
                variant="outline"
                className="border-2 border-highlight text-highlight hover:bg-highlight/5 rounded-2xl font-bold"
              >
                Voltar para o login
              </Button>
            </motion.div>
